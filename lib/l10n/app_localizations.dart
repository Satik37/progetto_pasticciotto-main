...
abstract class AppLocalizations {
  ...
  /// No description provided for @creditsAndSupport.
  ///
  /// In en, this message translates to:
  /// **'Credits and Support'**
  String get creditsAndSupport;
  ...
  /// No description provided for @categoriesFooter.
  ///
  /// In en, this message translates to:
  /// **'Traveling the universe for new tales...'**
  String get categoriesFooter;

  /// No description provided for @logicPageTitle.
  ///
  /// In en, this message translates to:
  /// **'Logic and Deduction'**
  String get logicPageTitle;

  /// No description provided for @logicPageSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Venture into the abyss: where logic meets lunacy.'**
  String get logicPageSubtitle;

  /// No description provided for @historicalPageTitle.
  ///
  /// In en, this message translates to:
  /// **'Historical Fiction'**
  String get historicalPageTitle;

  /// No description provided for @historicalPageSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @errorLoadingPuzzles.
  ///
  /// In en, this message translates to:
  /// **'Error loading puzzles: {error}'**
  String errorLoadingPuzzles(Object error);

  /// No description provided for @errorLoadingHistoricalPuzzles.
  ///
  /// In en, this message translates to:
  /// **'Error loading historical puzzles: {error}'**
